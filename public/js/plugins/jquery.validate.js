    ...
    $.extend($.fn, {
        ...
        validate: function (options) {
            ...
            if (validator.settings.onsubmit) {
                ...
                this.on('click','.icon-error',function(){
                    $(this).parent().find('input.error').val('')
                })
            }
            ...
            remote: function (value, element, param, method) {
                ...
                $.ajax($.extend(true, {
                    ...
                    success: function (response) {
                        var valid = response === true || response === "true" || response.code == '200'|| response.successed||response.success
                        ...
                        if (valid) {
                            ...
                            errors = {};
                            message = (response&&response.msg)||(response&&response.message) ||response|| validator.defaultMessage(element, {
                                    method: method,
                                    parameters: value
                                });
