    ...
    <div class="m-page">
        ...
        <div class="g-mainer">
            <div class="md-act">
                <div class="wp">
                    <div class="md-bonus">
                        <div class="maintitle"><img src="@/assets/images/event/august/title1.png" alt=""></div>
                        <div class="maindesc">待收本金满1000元可领，每日限量5张</div>
                        <ul class="list clearfix mt-30">
                            <li v-for="rule in rules" :key="rule.ruleId" :class="count>=5?'disabled':''">
                            ...
                            <div class="game-goods-list">
                                <div class="game-goods goods1">
                                    <ul :class="['game-goods-ul',startGameFlag0?'fx-roll':'']" :style="'transform:translateY(-'+settings.gameP0+'px);'">
                                        <li style="height:212px" v-for="(imgUrl,index) in picList" :key="'imgs1'+index"><img :src="imgUrl"></li>
                                    </ul>
                                </div>
                                <div class="game-goods goods2">
                                    <ul :class="['game-goods-ul',startGameFlag1?'fx-roll':'']" :style="'transform:translateY(-'+settings.gameP1+'px);'">
                                        <li style="height:212px" v-for="(imgUrl,index) in picList" :key="'imgs2'+index"><img :src="imgUrl"></li>
                                    </ul>
                                </div>
                                <div class="game-goods goods3">
                                    <ul :class="['game-goods-ul',startGameFlag2?'fx-roll':'']" :style="'transform:translateY(-'+settings.gameP2+'px);'">
                                        <li style="height:212px" v-for="(imgUrl,index) in picList" :key="'imgs3'+index"><img :src="imgUrl"></li>
                                    </ul>
                                </div>
                            </div>
                            <div class="maindesc">单笔出借满2000获得1次抽奖机会</div>
                    ...
                    <div class="md-rule mt-60">
                        <div class="maintitle"><img src="@/assets/images/event/august/title2.png" alt=""></div>
                        <div class="bd">
                ...
                <EventFooter background='#048498' color="#fff" :height="80" class="mt-60"></EventFooter>
            </div>
        </div>
        <!-- 登录modal -->
        ...
        <a-modal class="md-bonuslayer" :title="false" :visible="bonusDiv.ifShow" :maskClosable="false" :bodyStyle="couponDiv.bodyStyle" wrapClassName="getbonusModal"
           ...
           <div class="md-bonustip">
                ...
                <div class="text-c pt-30"><img src="@/assets/images/event/august/lucked.png" alt=""></div>
                <div class="bonusdiv mt-20"><img alt="" src="@/assets/images/event/august/look.png" height="200"></div>
        ...
        <a-modal class="md-bonuslayer" :title="false" :visible="couponDiv.ifShow" :maskClosable="false" :bodyStyle="bonusDiv.bodyStyle" wrapClassName="getbonusModal"
            ...
            <div class="md-bonustip">
                <div class="bd" v-if="!couponDiv.success&&couponDiv.status==0">
                    ...
                    <div class="bonusdiv"><div class="nobonus"><img alt="" src="@/assets/images/event/august/dog.png"></div></div>
                ...
                <div class="bd" v-if="couponDiv.success">
                    <div class="close" @click="couponDiv.ifShow=false"><i class="icon-font icon-close"></i></div>
                    <div class="text-c pt-10"><img src="@/assets/images/event/august/win.png" alt=""></div>
        ...
        <a-modal :title="false" :visible="couponRecord.ifShow" :maskClosable="false" :bodyStyle="bonusDiv.bodyStyle" wrapClassName="getbonusModal"
            ...
            <div class="md-bonusrecord">
                <div class="title"><img src="@/assets/images/event/august/record.png" alt=""></div>
...
import p1 from '@/assets/images/event/august/p1.png'
import p2 from '@/assets/images/event/august/p2.png'
import p3 from '@/assets/images/event/august/p3.png'
import p4 from '@/assets/images/event/august/p4.png'
import p5 from '@/assets/images/event/august/p5.png'
import p6 from '@/assets/images/event/august/p6.png'
import p7 from '@/assets/images/event/august/p7.png'
import p8 from '@/assets/images/event/august/p8.png'
...
export default {
    ...
    methods:{
        ...
        initData(){
            this.$post('/event/2019/august').then(res => {
        ...
        startGame(){
            this.$post('/event/2019/augustAward').then(res => {
                let data=toJson(res);
        ...
        initCouponRecord(pageNo){
            this.$post('/event/2019/augustRecod',{pageNo:pageNo,pageSize:this.couponRecord.pageSize}).then(res => {
                let result=toJson(res)
...
@import "~@/assets/style/event/nineaugust.less";
