                ...
                <section class="ma-notice-notice pdabout" >
                    ...
                    <div class="mn newscontent">
                        ...
                        <div class="page mt-40" v-if="hasPage">
                            <a-pagination :pageNo="pageNo" :pageSize="pageSize" :total="total" @change="initData"/>
                        </div>
                    </div>
                </section>
            </div>
...
export default {
    ...
    data() {
        return {
            ...
            sideMenus:[
                ...
                {name:'平台公告',link:'/spa/about/notice/notice',onClass:true},
                {name:'行业资讯',link:'/spa/about/notice/news'},
    ...
    methods: {
        initData(pageNo){
            let _this=this;
            _this.pageNo=pageNo;
            _this.$post('/article/notice/ajList',{pageNo:pageNo,pageSize:_this.pageSize,qType:0})
                .then(function (res) {
                   ...
                   _this.dataList= JSON.parse(res).data
                    for (const x of _this.dataList) {
                        let url ='/spa/article/notice/'+x.uuid;
