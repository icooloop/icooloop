          ...
          function setLi(){
          	for (var j = 1; j <= settings.game_pagesize; j++) {
          		for (var i = 1; i <= gameLen; i++) {
          			gameArr.push({'type':j,'index':i,'src':basePath+'/public/images/event/act201810/p'+i+'.png'});
          		}
          	}
          }
          //写入，初始化奖品的滚动
         		                 ...
         		                 layer.msg(data.msg);
         		             	 ...
         		             	 if(data.code==1){
	   	      		            	...
	   	      		            	if(awardPic==0){
	   	      		            	 	...
	   	      		            	 	settings.zj_arr.bonusResult='<div class="bonusimg"><img alt="" src="/public/images/event/act201810/p'+(awardPic+1)+'.png"></div>';
	   	      		            	}
          ...
          function gameover(){
        	  ...
        	  if(settings.zj_arr.is_win==0){//没有抽奖机会
        			...
        			setTimeout(function(){
            			...
            			$("#bonusResult").html('<div class="nobonus"><img alt="" src="/public/images/event/act201810/dog.png"></div>');
            			$("#bonusBtn").html('<a href="javascript:layer.closeAll();" class="btn-bonus">继续抽奖</a>');
            			bonusTip(settings.zj_arr.is_win);
        			},4200);
        		}
