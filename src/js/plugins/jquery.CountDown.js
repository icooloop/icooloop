            ...
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    if (data[$self.defs.successName]) {
                        ...
                        if($self.defs.callBack){
                        	$self.defs.callBack(data);
                        }else{
                        	 layer.msg(data[$self.defs.isCallBack]);
                        	 $self.defs.errorMsg=data[$self.defs.isCallBack];
                        }
                        $self.CountDownDo();
                        $self.Tid = setInterval(function () {
                            $self.CountDownDo();
